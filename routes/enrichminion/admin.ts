...
app.post("/getOneLog", adminVerification, async (req: Request, res: Response): Promise<void> => {
    try {
...
app.get("/getAllLogs", adminVerification, async (req: Request, res: Response): Promise<void> => {
    try {
...
app.get("/getUserLogs", adminVerification, async (req: Request, res: Response): Promise<void> => {
    try {
...
app.delete("/deleteLog", adminVerification, async (req: Request, res: Response): Promise<void> => {
    try {
        const { logID } = req.body;
        const log = await getOneLog(logID);
